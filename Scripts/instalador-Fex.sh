...
wget https://github.com/OpomboMORTO/FEX-android/raw/b41929dc029e30ea7bf902f2803bdc7cad88859f/Apps/termux-x11-nightly-1.02.07-0-all.deb &>/dev/null && dpkg -i ./*.deb &>/dev/null && rm -rf ./*.deb &>/dev/null
